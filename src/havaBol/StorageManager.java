...
/**
 * This class manages the life cycle of variables and provides values when
 * needed.
 * <p>
 * TODO This class will need to remove variables from the varTable when they go
 * out of scope in the future.
 * <p>
 * 
 * @author ckw273
 *
...
public class StorageManager implements Cloneable {
	 ...
	 * 
	 * @param varString
	 *            - Identifier used as a key into the varTable hash map
	 * @return
	 */
	 ...
	 *            - Identifier used as a key into the varTable hash map
	 * @param value
	 *            - Value to insert or replace in the hash map
	 */
